!(function () {
  ...
  var c = {},
        ...
        (r = [
          {
            ...
            value: function (e) {
              ...
              return (
                (this.subscribe = y),
                this.subscribe && (g.subscribe = this.subscribe),
                g.subscribe && (this.subscribe = g.subscribe),
                (this.ts = Date.now()),
                (c[this.ts] = this),
    ...
    l = function (e) {
      var r = e.id,
        ...
        f = { id: t, params: o };
      s.BROWSER === t &&
        ((f.params.target = o.target || ''),
        (f.params.fullMode = !0),
        (f.id = 'com.webos.app.browser')),
        (function (e) {
          var r = e.parameters,
            t = e.onSuccess,
            n = e.onFailure;
        ...
        })({ parameters: f, onSuccess: u, onFailure: l });
    },
    f = function () {
      var e = {};
  ...
  var O = {
    ...
    g = { PLAYREADY: 'playready', WIDEVINE: 'widevine' },
    S = function (e) {
      var r = e.method,
        t = e.parameters,
        n = e.onComplete;
    ...
    T = function (e, r) {
      var t = r.errorCode,
        n = void 0 === t ? O.UNKNOWN_ERROR : t,
        o = r.errorText,
        i = { errorCode: n, errorText: void 0 === o ? 'Unknown error.' : o };
                    ...
                    if (
                      ...
                      return i(
                        T(r, {
                          ...
                          errorText:
                            'DRM types of set and loaded are not matched.',
                        }),
                      );
                    var t = p({}, e);
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (1 !== this.state && 2 !== this.state) {
                var u = { appId: d(), drmType: this.drmType };
                (this.state = 1),
                  S({
                    method: 'load',
                    onComplete: function (e) {
              ...
              } else w(n, { isLoaded: !0, clientId: this.clientId });
            },
          },
          {
            key: 'unload',
                ...
                var a = (function (e) {
                    ...
                    switch (e) {
                      case g.PLAYREADY:
                        ...
                        break;
                      case g.WIDEVINE:
                        (r = 'application/widevine+xml'),
                          (t = 'urn:dvb:casystemid:19156');
                    }
          ...
          (function (e) {
            ...
            new a().send({
              ...
              onComplete: function (e) {
                ...
                if ((delete r.returnValue, !0 === e.returnValue))
                  return delete r.subscribe, void n(r);
    ...
    V = function (e) {
      ...
      -1 !== navigator.userAgent.indexOf('Chrome')
        ? new a().send({
            ...
            onComplete: function (e) {
              if (!0 !== e.returnValue)
                o({ errorCode: e.errorCode, errorText: e.errorText });
              else {
