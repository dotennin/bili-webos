...
const source = fs.readFileSync(
  path.join(import.meta.dir, 'LivePlayerPage.tsx'),
  'utf8',
);
...
const getMpegtsModule = new Function(
  `${extractFunction('getMpegtsModule')}; return getMpegtsModule;`,
)();
const configureShakaForLive = new Function(
  `${extractFunction('configureShakaForLive')}; return configureShakaForLive;`,
)();
